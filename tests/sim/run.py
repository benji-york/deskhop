...
BACKGROUND_FALSE = BEHAVIOR_BACKGROUND_FALSE | MOUSE_BACKGROUND_FALSE | UART_BACKGROUND_FALSE | BOOTLOADER_BACKGROUND_FALSE
SCENARIOS={**TRANSPORT,**BEHAVIORS,**MOUSE_BUTTONS,**MOUSE_EXTRA,**SELECTION,**PEER_STATUS,**PEER_HISTORY,**VERIFICATION,**KEYBOARD_RELIABILITY,**UART_INTEGRITY,**WEB_CONFIG_BOOTLOADER,'generated':scenario_generated}
