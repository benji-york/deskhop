...
from test_configuration import SCENARIOS as CONFIGURATION, BACKGROUND_FALSE as CONFIG_BACKGROUND_FALSE
BACKGROUND_FALSE = BEHAVIOR_BACKGROUND_FALSE | MOUSE_BACKGROUND_FALSE | UART_BACKGROUND_FALSE | BOOTLOADER_BACKGROUND_FALSE | SERIAL_BOOTLOADER_BACKGROUND_FALSE | FW_BATCH_BACKGROUND_FALSE | CONFIG_BACKGROUND_FALSE
SCENARIOS={**TRANSPORT,**BEHAVIORS,**MOUSE_BUTTONS,**MOUSE_EXTRA,**SELECTION,**PEER_STATUS,**PEER_HISTORY,**VERIFICATION,**KEYBOARD_RELIABILITY,**UART_INTEGRITY,**WEB_CONFIG_BOOTLOADER,**SERIAL_BOOTLOADER,**FW_BATCH,**CONFIGURATION,'generated':scenario_generated}
